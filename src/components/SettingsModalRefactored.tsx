    ...
    try {
      ...
      if (result.success) {
        if (result.localOnly) {
          ...
          // Model selections are saved to server. When modal reopens, loadSettings(true)
          // will fetch fresh settings including model selections. No need to reload models here.
        }
